	...
	<body>
		<div class="container">
			...
			<div class="jumbotron">
		  		...
		  		<div class="col-md-8">
		  			...
		  			<div class="panel panel-default">
										...
										<div class="form-group">
										    ...
										    <div class="col-sm-8"> 
										    	<select class="form-control" name="role" required id="role">
										    		...
										    		<option value="4" <?php echo ($row['User_Role'] == 4)? "selected":""; ?> >Student</option>
										    	</select>
										    </div>
										</div>
						...
						?>		
								...
								<div class="panel-heading"><h5>Add Students</h5></div>
		  	...
		  	<div class="row">
		  		<div class="panel panel-default">
					<div class="panel-heading"><h5>All Students</h5></div>
					<div class="panel-body">
						<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
						    ...
						    <tbody>
						    	...
						    	<?php
						    		...
						    		$sql = "SELECT * FROM users WHERE User_Role = '4'";
