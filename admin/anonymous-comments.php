	...
	<body>
		<div class="container">
			...
			<div class="jumbotron">
		  	...
		  	<div class="row">
		  		<div class="panel panel-default">
					<div class="panel-heading"><h5>All Anonymous Comments</h5></div>
						...
						<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
						    ...
						    <tbody>
						    	...
						    	<?php
						    		...
						    		$sql = "SELECT c.Comment_ID AS comId, c.User_ID, c.Idea_ID, c.Comment_Text, c.Comment_createdAt, c.Comment_Type, i.Idea_ID AS ideaId, i.Cat_ID, i.Idea_Title, i.Idea_Description, ca.Cat_ID, ca.Cat_Name, ca.Cat_Note, u.User_Username, u.User_ID AS uid FROM comments c INNER JOIN ideas i ON i.Idea_ID = c.Idea_ID INNER JOIN categories ca ON ca.Cat_ID = i.Cat_ID INNER JOIN users u ON u.User_ID = c.User_ID WHERE c.Comment_Type = '0' ORDER BY c.Comment_ID DESC";
