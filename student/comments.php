						...
						<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
						    ...
						    <tbody>
						    	...
						    	<?php
						    		...
						    		$sql = "SELECT c.Comment_ID AS comId, c.User_ID, c.Idea_ID, c.Comment_Text, c.Comment_createdAt, i.Idea_ID AS ideaId, i.Cat_ID, i.Idea_Title, i.Idea_Description, ca.Cat_ID, ca.Cat_Name, ca.Cat_Note, u.User_Username, u.User_ID AS uid FROM comments c INNER JOIN ideas i ON i.Idea_ID = c.Idea_ID INNER JOIN categories ca ON ca.Cat_ID = i.Cat_ID INNER JOIN users u ON u.User_ID = c.User_ID WHERE c.user_id ='".$userInfo['User_ID']."'";
