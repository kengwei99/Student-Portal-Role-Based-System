	...
	<body>
		<div class="container">
			...
			<div class="jumbotron">
		  		...
		  		<div class="col-md-8">
		  			...
		  			<div class="panel panel-default">
						...
						<?php
							...
							{
						?>
								<div class="panel-heading"><h5>Add New Idea</h5></div>
								<div class="panel-body">
									<form class="form-horizontal" action="../action.php" method="POST" enctype="multipart/form-data">
										<input type="hidden" name="userId" value="<?php echo $userInfo['User_ID'];?>">
									  	<div class="form-group">
										    <label class="control-label col-sm-4" for="title">Idea Title</label>
										    <div class="col-sm-8">
										      <input type="text" class="form-control" id="title" name="title" placeholder="Enter Idea Title" required>
										    </div>
									  	</div>
									  	<div class="form-group">
										    <label class="control-label col-sm-4" for="description">Description</label>
										    <div class="col-sm-8">
										    	<textarea class="form-control" id="description" name="description" required placeholder="Enter Idea Description"></textarea>
										    </div>
									  	</div>
									  	<div class="form-group">
										   ...
										   <div class="col-sm-8"> 
										    	<select class="form-control" name="category"  id="category" required>
											    	...
											    	?>
											    			...
											    			<option value="<?php echo $tableRow['Cat_ID'];?>"><?php echo $tableRow['Cat_Name'];?></option>
									  	...
									  	<div class="form-group">
										    <label class="control-label col-sm-4" for="password">Attachment</label>
										    <div class="col-sm-8">
											...
											<div class="col-md-offset-4 col-sm-6"> 
										      	<div class="checkbox">
												  	<label>
												  		...
												  		<a class="agree-button" href="" target="_balnk">I agree to terms</a>
												  	</label>
												</div>
										    </div>
										</div>
										...
										<div class="form-group"> 
										    <div class="col-sm-offset-4 col-sm-8">
										      <button type="submit" class="btn btn-default" name="addIdea">Add Idea</button>
										    </div>
										</div>
									</form>
								</div>
		  	...
		  	<div class="row">
		  		<div class="panel panel-default">
					<div class="panel-heading"><h5>My Ideas</h5></div>
						...
						<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
						    ...
						    <tbody>
						    	...
						    	<?php
									...
									$sql ="SELECT i.Idea_ID AS ideaId, i.Idea_Title, i.Idea_Description, i.Idea_createdAt, c.Cat_Name, o.User_Username FROM ideas i INNER JOIN categories c ON i.Cat_ID = c.Cat_ID INNER JOIN users o ON i.User_ID = o.User_ID  WHERE i.User_ID = '$user_id' ORDER BY i.Idea_ID DESC ";
