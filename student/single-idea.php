		  	...
		  	<div class="row">
		  		<div class="col-md-4">
		  			<div class="list-group">
					  	...
					  	<a href="ideas.php" class="list-group-item">Ideas</a>
					  	<a href="likes.php" class="list-group-item">Likes</a>
		  	...
		  	<div class="row">
		  		<div class="comments col-md-offset-2 col-md-8">
					...
					<?php
						...
						$sql ="SELECT c.Comment_ID as comId, c.User_ID, c.Idea_ID, c.Comment_Text, c.Comment_Type, c.Comment_isActive, c.Comment_createdAt, u.User_ID, u.User_Username, u.User_Role FROM comments c JOIN users u ON c.User_ID = u.User_ID JOIN ideas ON ideas.Idea_ID = c.Idea_ID WHERE c.Idea_ID = '$id' AND u.User_Role = 4";
			    			...
			    			?>
				    			<div class="comment-wrap">
									...
									<div class="comment-block">
										...
										<p>
											<a href="">
												<?php echo ($tableRow['Comment_Type'] == 1)?ucfirst($tableRow['User_Username']) : "Anonymous";?>
										...
										<p class="comment-text">
											...
											<?php echo $tableRow['Comment_Text'];?>
										...
										<div class="bottom-comment">
											<div class="comment-date">
												...
												<?php echo date_format(date_create($tableRow['Comment_createdAt']), "M d, Y @ h:i A");?>
