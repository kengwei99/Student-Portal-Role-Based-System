	...
	<body>
		<div class="container">
			...
			<div class="jumbotron">
		  	...
		  	<div class="row">
		  		<div class="panel panel-default">
					<div class="panel-heading"><h5>My Likes</h5></div>
						...
						<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
						    ...
						    <tbody>
						    	...
						    	<?php
						    		...
						    		$sql = "SELECT r.Rating_ID AS likeId, r.User_ID, r.Idea_ID, r.Rating_Action, r.Rating_CreatedAt, i.Idea_ID AS ideaId, i.Cat_ID, i.Idea_Title, i.Idea_Description, c.Cat_ID, c.Cat_Name, c.Cat_Note, u.User_Username, u.User_ID AS uid FROM rating_info r INNER JOIN ideas i ON i.Idea_ID = r.Idea_ID INNER JOIN categories c ON c.Cat_ID = i.Cat_ID INNER JOIN users u ON u.User_ID = r.User_ID WHERE r.user_id ='".$userInfo['User_ID']."'";
